        ...
        <div className='text-center text-black my-16'>
            <div>
                ...
                <div className='flex gap-5 justify-center mt-16 '>
                    <div>
                        <div className='w-50  flex flex-col items-start p-5 border-2 shadow-2xl border-blue-300 bg-white rounded-2xl gap-3'>
                    ...
                    <div>
                        <div className='w-50 border-2 border-blue-300 flex flex-col items-start p-5 bg-white shadow-2xl rounded-2xl gap-3'>
