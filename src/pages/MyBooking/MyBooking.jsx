...
const MyBooking = () => {
    ...
    return (
        <div className='text-black w-11/12  m-auto'>
            ...
            {
                bookMarkedDoctors.map((docInfo, i) => {
                    ...
                    return (
                        <div key={i} className='bg-white my-10 p-5  rounded-2xl shadow-2xs'>
                            ...
                            <button onClick={()=> removeBookList(docInfo.id)} className='text-red-500 border w-full font-bold py-1 px-8 rounded-full'>Cancel from Book List</button>
                        </div>
                    )
                })
            }
